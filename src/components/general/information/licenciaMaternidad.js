...
const LicenciaMaternidad = () => {
  return (
    <div style={styles.container}>
      <img src={process.env.PUBLIC_URL +"/maternidad.jpg"} alt="Imagen" style={styles.image} />
      <h1 style={styles.title}>Licencias de maternidad/paternidad</h1>
      <p style={styles.text}>
...
export default LicenciaMaternidad;
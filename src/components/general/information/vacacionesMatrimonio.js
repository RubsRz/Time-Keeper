...
const VacacionesMatrimonio = () => {
  return (
    <div style={styles.container}>
      <img src={process.env.PUBLIC_URL +"/matrimonio.jpg"} alt="Imagen" style={styles.image} />
      <h1 style={styles.title}>Vacaciones por matrimonio</h1>
      <p style={styles.text}>
...
export default VacacionesMatrimonio;